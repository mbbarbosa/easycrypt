...
print A_query_bound. 
call (A_query_bound (Distinguisher_Oracle(Wrapped_QRO(RO), RepO(Wrapped_QRO(RO)))) (DummyRO(Wrapped_QRO(RO)))).
*)
admit.
qed.
...
declare module A <: Adv_EFKOA_RO {-QRO}.
